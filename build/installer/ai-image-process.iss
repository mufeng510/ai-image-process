; Inno Setup script for AI Image Process (Windows x64 onedir)
...
LicenseFile=..\..\LICENSE
OutputDir=..\..\dist
OutputBaseFilename=AI-Image-Process-windows-x64-setup
Compression=lzma
...
[Files]
Source: "..\..\dist\AI-Image-Process\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
